...
public enum Stack {
    ...
    COMBINE("Combine"), XCTEST("XCTest"), TUIST("Tuist"), REACTIVENATIVE("ReactiveNative"), FLUTTER("Flutter"),
    KOTIIN("Kotlin"), JAVA("Java"), COMPOSE("Compose"), RXJAVA("RXJava"), COROUTINE("Coroutine"),
